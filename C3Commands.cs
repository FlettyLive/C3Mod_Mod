		...
		public static void Stop(CommandArgs args)
		{
			if (args.Parameters.Count > 0)
			{
				switch (args.Parameters[0])
				{
					...
					case "apoc": //NEW CODE TO EXPAND THE APOCAYLPSE //Changes apocalypse to apoc
						{
			...
			if (!C3Mod.VoteRunning)
			{
				...
				if (TotalAvialPlayers > 0)
				{
					if (args.Parameters.Count > 0)
					{
						...
						///Gametype Divider
						///Apocalypse
						else if (args.Parameters[0].ToLower() == "apoc")  //NEW CODE TO EXPAND THE APOCAYLPSE //Changes apocalypse to apoc
						{
